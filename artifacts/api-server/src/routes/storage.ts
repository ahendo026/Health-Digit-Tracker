...
function parseRequestUploadUrlBody(body: unknown): { success: true; data: RequestUploadUrlBodyType } | { success: false } {
  ...
  if (typeof b.name !== "string" || typeof b.contentType !== "string") return { success: false };
  return { success: true, data: { name: b.name, size: Number(b.size) || 0, contentType: b.contentType } };
}
